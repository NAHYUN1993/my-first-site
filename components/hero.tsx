...
export function Hero() {
  ...
  // 초기 데이터 - 배열 형태로 변경
  const defaultSocialLinks = [{"name":"Instagram","icon":"instagram","url":"https://www.instagram.com/string.ai.loom?igsh=MWJzZDc1a2Uwd3dhNQ%3D%3D&utm_source=qr"},{"name":"YouTube","icon":"youtube","url":"https://youtube.com/@pulnip?si=xb-qReHjTEeYETCP"}]
