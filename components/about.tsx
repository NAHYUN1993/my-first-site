...
export function About() {
  ...
  const defaultInfo = {
    ...
    background: {"image":"","video":"","color":"#e8f3f7","opacity":0.1},
    experienceCards: [{"icon":"briefcase","title":"회사명","period":"2021 - 현재","description":"매니저"},{"icon":"graduation","title":"학교명","period":"2016 - 2020","description":"전공 및 학위"},{"icon":"award","title":"자격증/수상","period":"2021","description":"설명을 입력하세요"}],
    skills: [{"icon":"video","title":"영상 제작 능력","description":"Premiere Pro\nAfter Effects"},{"icon":"camera","title":"이미지 편집 능력","description":"Photoshop\nLightroom Classic\n"},{"icon":"star","title":"촬영 능력","description":"Sony a7m3"},{"icon":"lightbulb","title":"AI 제작 능력","description":"Kling AI\nNano Banana"}],
    storyTitle: "나의 이야기",
